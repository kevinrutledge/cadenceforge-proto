import{a as A,r as v,i as K,O as M,x as d,V as I,n as H,d as Y,f as pe,h as q,s as $e,_ as _e}from"./state-BGMZkYOB.js";const Se={};function je(a,e,n){const[t,i,r]=a;switch(t){case"noop":return e;case"writing/save":{const{slug:s}=i,{onSuccess:l,onFailure:o}=r||{};return[e,Pe(i,n).then(g=>(l&&l(),["writing/load",{slug:s,writing:g}])).catch(g=>(o&&o(g),["noop"]))]}case"writing/request":{const{slug:s}=i;return e.writing?.slug===s?e:[{...e,writing:{slug:s}},Ce(i,n).then(l=>["writing/load",{slug:s,writing:l}])]}case"writing/load":{const{writing:s}=i;return{...e,writing:s}}case"writing-list/request":return e.writingList?e:[e,ze(n).then(s=>["writing-list/load",{writings:s}])];case"writing-list/load":{const{writings:s}=i;return{...e,writingList:s}}case"project/request":{const{slug:s}=i;return e.project?.slug===s?e:[{...e,project:{slug:s}},Re(i,n).then(l=>["project/load",{slug:s,project:l}])]}case"project/save":{const{slug:s}=i,{onSuccess:l,onFailure:o}=r||{};return[e,Oe(i,n).then(g=>(l&&l(),["project/load",{slug:s,project:g}])).catch(g=>(o&&o(g),["noop"]))]}case"project/load":{const{project:s}=i;return{...e,project:s}}case"projects-list/request":return e.projectsList?e:[e,Te(n).then(s=>["projects-list/load",{projects:s}])];case"projects-list/load":{const{projects:s}=i;return{...e,projectsList:s}}default:{const s=t;throw new Error(`Unhandled message "${s}"`)}}}function Ce(a,e){return fetch(`/api/writing/${a.slug}`,{headers:A.headers(e)}).then(n=>{if(n.status===200)return n.json();throw new Error(`Failed to load writing: ${a.slug}`)}).then(n=>{if(n)return n;throw new Error("No JSON in response")})}function ze(a){return fetch("/api/writing",{headers:A.headers(a)}).then(e=>{if(e.status===200)return e.json();throw new Error("Failed to load writing list")}).then(e=>{if(e)return e;throw new Error("No JSON in response")})}function Re(a,e){return fetch(`/api/projects/${a.slug}`,{headers:A.headers(e)}).then(n=>{if(n.status===200)return n.json();throw new Error(`Failed to load project: ${a.slug}`)}).then(n=>{if(n)return n;throw new Error("No JSON in response")})}function Te(a){return fetch("/api/projects",{headers:A.headers(a)}).then(e=>{if(e.status===200)return e.json();throw new Error("Failed to load projects list")}).then(e=>{if(e)return e;throw new Error("No JSON in response")})}function Pe(a,e){return fetch(`/api/writing/${a.slug}`,{method:"PUT",headers:{"Content-Type":"application/json",...A.headers(e)},body:JSON.stringify(a.writing)}).then(n=>{if(n.status===200)return n.json();throw new Error(`Failed to save writing: ${a.slug}`)}).then(n=>{if(n)return n;throw new Error("No JSON in response")})}function Oe(a,e){return fetch(`/api/projects/${a.slug}`,{method:"PUT",headers:{"Content-Type":"application/json",...A.headers(e)},body:JSON.stringify(a.project)}).then(n=>{if(n.status===200)return n.json();throw new Error(`Failed to save project: ${a.slug}`)}).then(n=>{if(n)return n;throw new Error("No JSON in response")})}var Ae=Object.defineProperty,Ie=(a,e,n,t)=>{for(var i=void 0,r=a.length-1,s;r>=0;r--)(s=a[r])&&(i=s(e,n,i)||i);return i&&Ae(e,n,i),i};class ue extends K{constructor(){super(...arguments),this.authenticated=!1,this._authObserver=new M(this,"cadenceforge:auth")}connectedCallback(){super.connectedCallback(),this._authObserver.observe(n=>{n.user&&n.user.authenticated?this.authenticated=!0:this.authenticated=!1}),localStorage.getItem("theme")==="dark"&&document.body.classList.add("dark-mode")}firstUpdated(){const e=this.querySelector(".theme-toggle");e&&e.addEventListener("click",()=>{document.body.classList.contains("dark-mode")?(document.body.classList.remove("dark-mode"),localStorage.setItem("theme","light")):(document.body.classList.add("dark-mode"),localStorage.setItem("theme","dark"))})}render(){return d`
    ...
    `}handleSignOut(e){e.preventDefault();const n=new CustomEvent("auth:message",{bubbles:!0,composed:!0,detail:["auth/signout"]});this.dispatchEvent(n)}createRenderRoot(){return this}}Ie([v()],ue.prototype,"authenticated");class Le extends K{render(){return d`
    ...
    `}createRenderRoot(){return this}}var Ee=Object.defineProperty,De=Object.getOwnPropertyDescriptor,de=(a,e,n,t)=>{for(var i=De(e,n),r=a.length-1,s;r>=0;r--)(s=a[r])&&(i=s(e,n,i)||i);return i&&Ee(e,n,i),i};class V extends I{get writings(){return this.model.writingList||[]}get projects(){return this.model.projectsList||[]}constructor(){super("cadenceforge:model")}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["writing-list/request"]),this.dispatchMessage(["projects-list/request"])}render(){const e=this.writings.slice(0,2),n=this.projects.filter(t=>!t.status?.toLowerCase().includes("completed"));return d`
      <div class="page-hero">
        <div class="container">
          <h1>Cadence Forge</h1>
          <p>
    ...
    `}formatDate(e){return new Date(e).toLocaleDateString("en-US",{month:"long",year:"numeric"})}createRenderRoot(){return this}}de([v()],V.prototype,"writings");de([v()],V.prototype,"projects");class qe extends K{render(){return d`
      <div class="page-hero">
        <div class="container">
    ...
    `}createRenderRoot(){return this}}var Me=Object.defineProperty,Be=Object.getOwnPropertyDescriptor,Ne=(a,e,n,t)=>{for(var i=Be(e,n),r=a.length-1,s;r>=0;r--)(s=a[r])&&(i=s(e,n,i)||i);return i&&Me(e,n,i),i};class ge extends I{get writings(){return this.model.writingList||[]}constructor(){super("cadenceforge:model")}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["writing-list/request"])}render(){return d`
      <div class="page-hero">
        <div class="container">
    ...
    `}formatDate(e){return new Date(e).toLocaleDateString("en-US",{month:"long",year:"numeric"})}createRenderRoot(){return this}}Ne([v()],ge.prototype,"writings");function fe(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let L=fe();function Ze(a){L=a}const me=/[&<>"']/,Ue=new RegExp(me.source,"g"),ke=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,We=new RegExp(ke.source,"g"),He={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},se=a=>He[a];function y(a,e){if(e){if(me.test(a))return a.replace(Ue,se)}else if(ke.test(a))return a.replace(We,se);return a}const Fe=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function we(a){return a.replace(Fe,(e,n)=>(n=n.toLowerCase(),n==="colon"?":":n.charAt(0)==="#"?n.charAt(1)==="x"?String.fromCharCode(parseInt(n.substring(2),16)):String.fromCharCode(+n.substring(1)):""))}const Qe=/(^|[^\[])\^/g;function w(a,e){a=typeof a=="string"?a:a.source,e=e||"";const n={replace:(t,i)=>(i=i.source||i,i=i.replace(Qe,"$1"),a=a.replace(t,i),n),getRegex:()=>new RegExp(a,e)};return n}const Je=/[^\w:]/g,Ge=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function ae(a,e,n){if(a){let t;try{t=decodeURIComponent(we(n)).replace(Je,"").toLowerCase()}catch{return null}if(t.indexOf("javascript:")===0||t.indexOf("vbscript:")===0||t.indexOf("data:")===0)return null}e&&!Ge.test(n)&&(n=Ve(e,n));try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const Z={},Xe=/^[^:]+:\/*[^/]*$/,Ke=/^([^:]+:)[\s\S]*$/,Ye=/^([^:]+:\/*[^/]*)[\s\S]*$/;function Ve(a,e){Z[" "+a]||(Xe.test(a)?Z[" "+a]=a+"/":Z[" "+a]=U(a,"/",!0)),a=Z[" "+a];const n=a.indexOf(":")===-1;return e.substring(0,2)==="//"?n?e:a.replace(Ke,"$1")+e:e.charAt(0)==="/"?n?e:a.replace(Ye,"$1")+e:a+e}const W={exec:function(){}};function le(a,e){const n=a.replace(/\|/g,(r,s,l)=>{let o=!1,g=s;for(;--g>=0&&l[g]==="\\";)o=!o;return o?"|":" |"}),t=n.split(/ \|/);let i=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),t.length>e)t.splice(e);else for(;t.length<e;)t.push("");for(;i<t.length;i++)t[i]=t[i].trim().replace(/\\\|/g,"|");return t}function U(a,e,n){const t=a.length;if(t===0)return"";let i=0;for(;i<t;){const r=a.charAt(t-i-1);if(r===e&&!n)i++;else if(r!==e&&n)i++;else break}return a.slice(0,t-i)}function et(a,e){if(a.indexOf(e[1])===-1)return-1;const n=a.length;let t=0,i=0;for(;i<n;i++)if(a[i]==="\\")i++;else if(a[i]===e[0])t++;else if(a[i]===e[1]&&(t--,t<0))return i;return-1}function tt(a){a&&a.sanitize&&!a.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}function oe(a,e){if(e<1)return"";let n="";for(;e>1;)e&1&&(n+=a),e>>=1,a+=a;return n+a}function ce(a,e,n,t){const i=e.href,r=e.title?y(e.title):null,s=a[1].replace(/\\([\[\]])/g,"$1");if(a[0].charAt(0)!=="!"){t.state.inLink=!0;const l={type:"link",raw:n,href:i,title:r,text:s,tokens:t.inlineTokens(s)};return t.state.inLink=!1,l}return{type:"image",raw:n,href:i,title:r,text:y(s)}}function nt(a,e){const n=a.match(/^(\s+)(?:```)/);if(n===null)return e;const t=n[1];return e.split(`
`).map(i=>{const r=i.match(/^\s+/);if(r===null)return i;const[s]=r;return s.length>=t.length?i.slice(t.length):i}).join(`
`)}class ee{constructor(e){this.options=e||L}space(e){const n=this.rules.block.newline.exec(e);if(n&&n[0].length>0)return{type:"space",raw:n[0]}}code(e){const n=this.rules.block.code.exec(e);if(n){const t=n[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:n[0],codeBlockStyle:"indented",text:this.options.pedantic?t:U(t,`
`)}}}fences(e){const n=this.rules.block.fences.exec(e);if(n){const t=n[0],i=nt(t,n[3]||"");return{type:"code",raw:t,lang:n[2]?n[2].trim().replace(this.rules.inline._escapes,"$1"):n[2],text:i}}}heading(e){const n=this.rules.block.heading.exec(e);if(n){let t=n[2].trim();if(/#$/.test(t)){const i=U(t,"#");(this.options.pedantic||!i||/ $/.test(i))&&(t=i.trim())}return{type:"heading",raw:n[0],depth:n[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(e){const n=this.rules.block.hr.exec(e);if(n)return{type:"hr",raw:n[0]}}blockquote(e){const n=this.rules.block.blockquote.exec(e);if(n){const t=n[0].replace(/^ *>[ \t]?/gm,""),i=this.lexer.state.top;this.lexer.state.top=!0;const r=this.lexer.blockTokens(t);return this.lexer.state.top=i,{type:"blockquote",raw:n[0],tokens:r,text:t}}}list(e){let n=this.rules.block.list.exec(e);if(n){let t,i,r,s,l,o,g,f,m,k,h,j,$=n[1].trim();const z=$.length>1,b={type:"list",raw:"",ordered:z,start:z?+$.slice(0,-1):"",loose:!1,items:[]};$=z?`\\d{1,9}\\${$.slice(-1)}`:`\\${$}`,this.options.pedantic&&($=z?$:"[*+-]");const x=new RegExp(`^( {0,3}${$})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;e&&(j=!1,!(!(n=x.exec(e))||this.rules.block.hr.test(e)));){if(t=n[0],e=e.substring(t.length),f=n[2].split(`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(e){return`<del>${e}</del>`}link(e,n,t){if(e=ae(this.options.sanitize,this.options.baseUrl,e),e===null)return t;let i='<a href="'+e+'"';return n&&(i+=' title="'+n+'"'),i+=">"+t+"</a>",i}image(e,n,t){if(e=ae(this.options.sanitize,this.options.baseUrl,e),e===null)return t;let i=`<img src="${e}" alt="${t}"`;return n&&(i+=` title="${n}"`),i+=this.options.xhtml?"/>":">",i}text(e){return e}}class be{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,n,t){return""+t}image(e,n,t){return""+t}br(){return""}}class xe{constructor(){this.seen={}}serialize(e){return e.toLowerCase().trim().replace(/<[!\/a-z].*?>/ig,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(e,n){let t=e,i=0;if(this.seen.hasOwnProperty(t)){i=this.seen[e];do i++,t=e+"-"+i;while(this.seen.hasOwnProperty(t))}return n||(this.seen[e]=i,this.seen[t]=0),t}slug(e,n={}){const t=this.serialize(e);return this.getNextSafeSlug(t,n.dryrun)}}class T{constructor(e){this.options=e||L,this.options.renderer=this.options.renderer||new te,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new be,this.slugger=new xe}static parse(e,n){return new T(n).parse(e)}static parseInline(e,n){return new T(n).parseInline(e)}parse(e,n=!0){let t="",i,r,s,l,o,g,f,m,k,h,j,$,z,b,x,E,C,_,S;const D=e.length;for(i=0;i<D;i++){if(h=e[i],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[h.type]&&(S=this.options.extensions.renderers[h.type].call({parser:this},h),S!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(h.type))){t+=S||"";continue}switch(h.type){case"space":continue;case"hr":{t+=this.renderer.hr();continue}case"heading":{t+=this.renderer.heading(this.parseInline(h.tokens),h.depth,we(this.parseInline(h.tokens,this.textRenderer)),this.slugger);continue}case"code":{t+=this.renderer.code(h.text,h.lang,h.escaped);continue}case"table":{for(m="",f="",l=h.header.length,r=0;r<l;r++)f+=this.renderer.tablecell(this.parseInline(h.header[r].tokens),{header:!0,align:h.align[r]});for(m+=this.renderer.tablerow(f),k="",l=h.rows.length,r=0;r<l;r++){for(g=h.rows[r],f="",o=g.length,s=0;s<o;s++)f+=this.renderer.tablecell(this.parseInline(g[s].tokens),{header:!1,align:h.align[s]});k+=this.renderer.tablerow(f)}t+=this.renderer.table(m,k);continue}case"blockquote":{k=this.parse(h.tokens),t+=this.renderer.blockquote(k);continue}case"list":{for(j=h.ordered,$=h.start,z=h.loose,l=h.items.length,k="",r=0;r<l;r++)x=h.items[r],E=x.checked,C=x.task,b="",x.task&&(_=this.renderer.checkbox(E),z?x.tokens.length>0&&x.tokens[0].type==="paragraph"?(x.tokens[0].text=_+" "+x.tokens[0].text,x.tokens[0].tokens&&x.tokens[0].tokens.length>0&&x.tokens[0].tokens[0].type==="text"&&(x.tokens[0].tokens[0].text=_+" "+x.tokens[0].tokens[0].text)):x.tokens.unshift({type:"text",text:_}):b+=_),b+=this.parse(x.tokens,z),k+=this.renderer.listitem(b,C,E);t+=this.renderer.list(k,j,$);continue}case"html":{t+=this.renderer.html(h.text);continue}case"paragraph":{t+=this.renderer.paragraph(this.parseInline(h.tokens));continue}case"text":{for(k=h.tokens?this.parseInline(h.tokens):h.text;i+1<D&&e[i+1].type==="text";)h=e[++i],k+=`
`+(h.tokens?this.parseInline(h.tokens):h.text);t+=n?this.renderer.paragraph(k):k;continue}default:{const re='Token with "'+h.type+'" type was not found.';if(this.options.silent){console.error(re);return}else throw new Error(re)}}}return t}parseInline(e,n){n=n||this.renderer;let t="",i,r,s;const l=e.length;for(i=0;i<l;i++){if(r=e[i],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]&&(s=this.options.extensions.renderers[r.type].call({parser:this},r),s!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(r.type))){t+=s||"";continue}switch(r.type){case"escape":{t+=n.text(r.text);break}case"html":{t+=n.html(r.text);break}case"link":{t+=n.link(r.href,r.title,this.parseInline(r.tokens,n));break}case"image":{t+=n.image(r.href,r.title,r.text);break}case"strong":{t+=n.strong(this.parseInline(r.tokens,n));break}case"em":{t+=n.em(this.parseInline(r.tokens,n));break}case"codespan":{t+=n.codespan(r.text);break}case"br":{t+=n.br();break}case"del":{t+=n.del(this.parseInline(r.tokens,n));break}case"text":{t+=n.text(r.text);break}default:{const o='Token with "'+r.type+'" type was not found.';if(this.options.silent){console.error(o);return}else throw new Error(o)}}}return t}}class X{constructor(e){this.options=e||L}static passThroughHooks=new Set(["preprocess","postprocess"]);preprocess(e){return e}postprocess(e){return e}}function rt(a,e,n){return t=>{if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,a){const i="<p>An error occurred:</p><pre>"+y(t.message+"",!0)+"</pre>";if(e)return Promise.resolve(i);if(n){n(null,i);return}return i}if(e)return Promise.reject(t);if(n){n(t);return}throw t}}function ve(a,e){return(n,t,i)=>{typeof t=="function"&&(i=t,t=null);const r={...t};t={...p.defaults,...r};const s=rt(t.silent,t.async,i);if(typeof n>"u"||n===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof n!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(n)+", string expected"));if(tt(t),t.hooks&&(t.hooks.options=t),i){const l=t.highlight;let o;try{t.hooks&&(n=t.hooks.preprocess(n)),o=a(n,t)}catch(m){return s(m)}const g=function(m){let k;if(!m)try{t.walkTokens&&p.walkTokens(o,t.walkTokens),k=e(o,t),t.hooks&&(k=t.hooks.postprocess(k))}catch(h){m=h}return t.highlight=l,m?s(m):i(null,k)};if(!l||l.length<3||(delete t.highlight,!o.length))return g();let f=0;p.walkTokens(o,function(m){m.type==="code"&&(f++,setTimeout(()=>{l(m.text,m.lang,function(k,h){if(k)return g(k);h!=null&&h!==m.text&&(m.text=h,m.escaped=!0),f--,f===0&&g()})},0))}),f===0&&g();return}if(t.async)return Promise.resolve(t.hooks?t.hooks.preprocess(n):n).then(l=>a(l,t)).then(l=>t.walkTokens?Promise.all(p.walkTokens(l,t.walkTokens)).then(()=>l):l).then(l=>e(l,t)).then(l=>t.hooks?t.hooks.postprocess(l):l).catch(s);try{t.hooks&&(n=t.hooks.preprocess(n));const l=a(n,t);t.walkTokens&&p.walkTokens(l,t.walkTokens);let o=e(l,t);return t.hooks&&(o=t.hooks.postprocess(o)),o}catch(l){return s(l)}}}function p(a,e,n){return ve(R.lex,T.parse)(a,e,n)}p.options=p.setOptions=function(a){return p.defaults={...p.defaults,...a},Ze(p.defaults),p};p.getDefaults=fe;p.defaults=L;p.use=function(...a){const e=p.defaults.extensions||{renderers:{},childTokens:{}};a.forEach(n=>{const t={...n};if(t.async=p.defaults.async||t.async||!1,n.extensions&&(n.extensions.forEach(i=>{if(!i.name)throw new Error("extension name required");if(i.renderer){const r=e.renderers[i.name];r?e.renderers[i.name]=function(...s){let l=i.renderer.apply(this,s);return l===!1&&(l=r.apply(this,s)),l}:e.renderers[i.name]=i.renderer}if(i.tokenizer){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");e[i.level]?e[i.level].unshift(i.tokenizer):e[i.level]=[i.tokenizer],i.start&&(i.level==="block"?e.startBlock?e.startBlock.push(i.start):e.startBlock=[i.start]:i.level==="inline"&&(e.startInline?e.startInline.push(i.start):e.startInline=[i.start]))}i.childTokens&&(e.childTokens[i.name]=i.childTokens)}),t.extensions=e),n.renderer){const i=p.defaults.renderer||new te;for(const r in n.renderer){const s=i[r];i[r]=(...l)=>{let o=n.renderer[r].apply(i,l);return o===!1&&(o=s.apply(i,l)),o}}t.renderer=i}if(n.tokenizer){const i=p.defaults.tokenizer||new ee;for(const r in n.tokenizer){const s=i[r];i[r]=(...l)=>{let o=n.tokenizer[r].apply(i,l);return o===!1&&(o=s.apply(i,l)),o}}t.tokenizer=i}if(n.hooks){const i=p.defaults.hooks||new X;for(const r in n.hooks){const s=i[r];X.passThroughHooks.has(r)?i[r]=l=>{if(p.defaults.async)return Promise.resolve(n.hooks[r].call(i,l)).then(g=>s.call(i,g));const o=n.hooks[r].call(i,l);return s.call(i,o)}:i[r]=(...l)=>{let o=n.hooks[r].apply(i,l);return o===!1&&(o=s.apply(i,l)),o}}t.hooks=i}if(n.walkTokens){const i=p.defaults.walkTokens;t.walkTokens=function(r){let s=[];return s.push(n.walkTokens.call(this,r)),i&&(s=s.concat(i.call(this,r))),s}}p.setOptions(t)})};p.walkTokens=function(a,e){let n=[];for(const t of a)switch(n=n.concat(e.call(p,t)),t.type){case"table":{for(const i of t.header)n=n.concat(p.walkTokens(i.tokens,e));for(const i of t.rows)for(const r of i)n=n.concat(p.walkTokens(r.tokens,e));break}case"list":{n=n.concat(p.walkTokens(t.items,e));break}default:p.defaults.extensions&&p.defaults.extensions.childTokens&&p.defaults.extensions.childTokens[t.type]?p.defaults.extensions.childTokens[t.type].forEach(function(i){n=n.concat(p.walkTokens(t[i],e))}):t.tokens&&(n=n.concat(p.walkTokens(t.tokens,e)))}return n};p.parseInline=ve(R.lexInline,T.parseInline);p.Parser=T;p.parser=T.parse;p.Renderer=te;p.TextRenderer=be;p.Lexer=R;p.lexer=R.lex;p.Tokenizer=ee;p.Slugger=xe;p.Hooks=X;p.parse=p;p.options;p.setOptions;p.use;p.walkTokens;p.parseInline;T.parse;R.lex;var st=Object.defineProperty,at=Object.getOwnPropertyDescriptor,F=(a,e,n,t)=>{for(var i=t>1?void 0:t?at(e,n):e,r=a.length-1,s;r>=0;r--)(s=a[r])&&(i=(t?s(e,n,i):s(i))||i);return t&&i&&st(e,n,i),i};class B extends I{constructor(){super("cadenceforge:model"),this.authenticated=!1,this.username="",this._authObserver=new M(this,"cadenceforge:auth")}get writing(){return this.model.writing}connectedCallback(){super.connectedCallback(),this._authObserver.observe(e=>{e.user&&e.user.authenticated?(this.authenticated=!0,this.username=e.user.username||""):(this.authenticated=!1,this.username="")})}attributeChangedCallback(e,n,t){super.attributeChangedCallback(e,n,t),e==="slug"&&n!==t&&t&&this.dispatchMessage(["writing/request",{slug:t}])}render(){return!this.writing||!this.writing.title?d`<div class="container"><p>Loading...</p></div>`:d`
      <main>
        <div class="container">
          <article>
            ...
            <header>
              ...
              ${this.authenticated&&this.username==="kevin"?d`<p>
    ...
    `}handleSubmit(e){this.dispatchMessage(["writing/save",{slug:this.slug,writing:e.detail},{onSuccess:()=>q.dispatch(this,"history/navigate",{href:`/app/writing/${this.slug}`}),onFailure:n=>console.error("Save failed:",n)}])}handleCancel(){q.dispatch(this,"history/navigate",{href:`/app/writing/${this.slug}`})}createRenderRoot(){return this}};ne.uses=Y({"mu-form":pe.Element});let P=ne;Q([H()],P.prototype,"slug",2);Q([v()],P.prototype,"writing",1);Q([v()],P.prototype,"authenticated",2);Q([v()],P.prototype,"username",2);var ct=Object.defineProperty,ht=Object.getOwnPropertyDescriptor,pt=(a,e,n,t)=>{for(var i=ht(e,n),r=a.length-1,s;r>=0;r--)(s=a[r])&&(i=s(e,n,i)||i);return i&&ct(e,n,i),i};class ye extends I{get projects(){return this.model.projectsList||[]}constructor(){super("cadenceforge:model")}connectedCallback(){super.connectedCallback(),this.dispatchMessage(["projects-list/request"])}render(){return d`
      <div class="page-hero">
        <div class="container">
    ...
    `}handleSubmit(e){this.dispatchMessage(["project/save",{slug:this.slug,project:e.detail},{onSuccess:()=>q.dispatch(this,"history/navigate",{href:`/app/projects/${this.slug}`}),onFailure:n=>console.error("Save failed:",n)}])}handleCancel(){q.dispatch(this,"history/navigate",{href:`/app/projects/${this.slug}`})}createRenderRoot(){return this}};ie.uses=Y({"mu-form":pe.Element});let O=ie;G([H()],O.prototype,"slug",2);G([v()],O.prototype,"project",1);G([v()],O.prototype,"authenticated",2);G([v()],O.prototype,"username",2);const mt=[{path:"/app/writing/:slug/edit",view:a=>d`
    ...
    `},{path:"/app/projects",view:()=>d` <projects-list-view></projects-list-view> `},{path:"/app/about",view:()=>d` <about-view></about-view> `},{path:"/app",view:()=>d` <home-view></home-view> `},{path:"/",redirect:"/app"}];Y({"mu-auth":A.Provider,"mu-history":q.Provider,"mu-switch":class extends _e.Element{constructor(){super(mt,"cadenceforge:history","cadenceforge:auth")}createRenderRoot(){return this}},"mu-store":class extends $e.Provider{constructor(){super(je,Se,"cadenceforge:auth")}},"cf-header":ue,"cf-footer":Le,"home-view":V,"about-view":qe,"writing-list-view":ge,"writing-view":B,"writing-edit":P,"projects-list-view":ye,"project-view":N,"project-edit":O});
