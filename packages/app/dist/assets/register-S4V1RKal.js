import{i as h,x as c,b as f,r as m,n as u,d as b,a as l}from"./state-DnAmevJH.js";var v=Object.defineProperty,i=(d,t,r,s)=>{for(var a=void 0,e=d.length-1,p;e>=0;e--)(p=d[e])&&(a=p(t,r,a)||a);return a&&v(t,r,a),a};const n=class n extends h{constructor(){super(...arguments),this.formData={},this.redirect="/app"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password&&this.formData.confirmPassword&&this.formData.password===this.formData.confirmPassword)}render(){const t=this.formData.password&&this.formData.confirmPassword&&this.formData.password!==this.formData.confirmPassword;return c`
      <form
