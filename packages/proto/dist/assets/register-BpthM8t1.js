import{i as h,x as c,b as f,r as m,n as u,d as l,F as b,H as v,a as w}from"./footer-B477tF5S.js";var g=Object.defineProperty,i=(d,t,r,s)=>{for(var a=void 0,e=d.length-1,p;e>=0;e--)(p=d[e])&&(a=p(t,r,a)||a);return a&&g(t,r,a),a};const n=class n extends h{constructor(){super(...arguments),this.formData={},this.redirect="/"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password&&this.formData.confirmPassword&&this.formData.password===this.formData.confirmPassword)}render(){const t=this.formData.password&&this.formData.confirmPassword&&this.formData.password!==this.formData.confirmPassword;return c`
      <form
  ...
  `;let o=n;i([m()],o.prototype,"formData");i([u()],o.prototype,"api");i([u()],o.prototype,"redirect");i([m()],o.prototype,"error");l({"mu-auth":w.Provider,"cf-header":v,"cf-footer":b,"register-form":o});
